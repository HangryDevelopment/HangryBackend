...
// String uri =
// "https://people.googleapis.com/v1/people/me?personFields=names,emailAddresses,photos&access_token="
// + accessToken;
...
// JsonObject jo =
// JsonParser.parseString(result.getBody().toString()).getAsJsonObject();
// String email =
// jo.get("emailAddresses").getAsJsonArray().get(0).getAsJsonObject().get("value").toString().replaceAll("\"",
// "");
// String photo =
// jo.get("photos").getAsJsonArray().get(0).getAsJsonObject().get("url").toString().replaceAll("\"",
// "");
// String userName =
// jo.get("names").getAsJsonArray().get(0).getAsJsonObject().get("displayName").toString().replaceAll("\"",
// "");
